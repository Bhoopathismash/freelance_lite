        ...
        <div class="row justify-content-center">
          <div class="col-lg-9 col-md-12 col-xs-12">
            <div class="post-job box">
        		...
        		<form id="rzp-footer-form" action="{{route('packagePayment')}}" method="POST" style="width: 100%; text-align: center" >
                @csrf

                <p>{{$package->name}}</p>   
                <br/>
                <p><br/>Price: {{$package->amount}}  </p>
                <input type="hidden" name="amount" id="amount" value="{{$package->amount}}"/>
                <div class="pay">
...
@section('scripts')
	...
	<script>
	    var options = {
	        ...
	        name: 'Pacakge - {{$package->name}}',
	        description: '{{$package->no_of_bids}}',
